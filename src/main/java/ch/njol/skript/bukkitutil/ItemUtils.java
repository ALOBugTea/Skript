...
public class ItemUtils {
	...
	public static int getMaxDamage(ItemStack itemStack) {
		// FIXME: Removed MaxDamage method for 1.11.2 compatibility
	...
	public static void setMaxDamage(ItemStack itemStack, int maxDamage) {
		throw new UnsupportedOperationException("Cannot set max damage on item stacks in Minecraft 1.11.2 and below");
//		ItemMeta meta = itemStack.getItemMeta();
...
//			return ((Damageable) meta).getMaxDamage();
	...
	static {
		...
		// FIXME: removed the following lines since using paper 1.19 api
//		// cherry
