...
public enum PotionDataUtils {
	...
	// FIXME: REMOVED NEWER SLOW and DAMAGE_RESISTANCE potion effects
	private static final PotionEffectType SLOW = PotionEffectType.getByName("SLOW");// PotionEffectUtils.HAS_OLD_POTION_FIELDS ? PotionEffectType.getByName("SLOW") : PotionEffectType.SLOWNESS;
	private static final PotionEffectType DAMAGE_RESISTANCE = PotionEffectType.getByName("DAMAGE_RESISTANCE");// PotionEffectUtils.HAS_OLD_POTION_FIELDS ? PotionEffectType.getByName("DAMAGE_RESISTANCE") : PotionEffectType.RESISTANCE;
